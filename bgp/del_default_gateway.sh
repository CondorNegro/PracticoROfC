...
docker exec -it bgp_r5_1 ip -6 route add default via 2001:aa51::11
docker exec -it bgp_r7_1 ip -6 route add default via 2001:aa71::11
docker exec -it bgp_r3_1 ip -6 route add default via 2001:aa31::11
docker exec -it bgp_r9_1 ip -6 route add default via 2001:cc93::3
